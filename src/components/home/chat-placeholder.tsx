...
const ChatPlaceHolder = () => {
  return (
    <aside className="w-3/4 bg-gray-secondary flex flex-col items-center justify-center py-10">
      <section className="flex flex-col items-center w-full justify-center py-10 gap-4">
        <Image
